        ...
        <body>
          ...
          <p style="font-size: 16pt; text-align: justify; margin: 15px 0; line-height: 1.5; font-family: Arial, sans-serif;">
            ${booking.type === 'Container Stuffing Report' 
              ? `WE HEREBY CERTIFY that the undersigned surveyors, acting at the request and on behalf of INTERPORT LOGÍSTICA LTDA., supervised the coffee cargo stuffing operation for the exporter ${exp.toUpperCase()}, as well as the fumigation process, the inspection conducted by MAPA (Brazilian Ministry of Agriculture and Livestock), and the application of the carrier's final seal to the containers at the Interport Logística REDEX Facility.`
              : `WE HEREBY CERTIFY that the undersigned surveyors, acting at the request and on behalf of INTERPORT LOGÍSTICA LTDA., supervised all operations carried out within the REDEX bonded area related to the export shipment of ${exp.toUpperCase()}, including the receiving process of the containers, the inspection conducted by MAPA (Brazilian Ministry of Agriculture and Livestock), and the application of the carrier's final seal at the Interport Logística REDEX Facility in Vila Velha, Brazil.`
            }
          </p>
                  ...
                  {page.type === 'cover' && (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                      ...
                      <p style={{ fontSize: '16px', textAlign: 'justify', margin: '8px 0', color: '#111', lineHeight: '1.5', fontWeight: '500', whiteSpace: 'pre-line' }}>
                        {booking.type === 'Container Stuffing Report'
                          ? `WE HEREBY CERTIFY that the undersigned surveyors, acting at the request and on behalf of INTERPORT LOGÍSTICA LTDA., supervised the coffee cargo stuffing operation for the exporter ${page.expName.toUpperCase()}, as well as the fumigation process, the inspection conducted by MAPA (Brazilian Ministry of Agriculture and Livestock), and the application of the carrier's final seal to the containers at the Interport Logística REDEX Facility.`
                          : `WE HEREBY CERTIFY that the undersigned surveyors, acting at the request and on behalf of INTERPORT LOGÍSTICA LTDA., supervised all operations carried out within the REDEX bonded area related to the export shipment of ${page.expName.toUpperCase()}, including the receiving process of the containers, the inspection conducted by MAPA (Brazilian Ministry of Agriculture and Livestock), and the application of the carrier's final seal at the Interport Logística REDEX Facility in Vila Velha, Brazil.`
                        }
                      </p>
